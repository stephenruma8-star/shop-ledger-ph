...
export function renderSupTable() {
  ...
  container.innerHTML = `<table class="data-table"><thead><tr><th class="p-3">Name</th><th class="p-3">Contact</th><th class="p-3 text-right">Purchased</th><th class="p-3 text-right">Paid</th><th class="p-3 text-right">Owed</th><th class="p-3 text-center">Actions</th></tr></thead>
