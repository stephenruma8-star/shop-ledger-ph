...
// Bridge for the Daily Report button: the dashboard module may still be loading
// (route code-splitting), so import it on demand instead of calling it directly.
export async function dailySalesReportBtn() {
...
Object.defineProperties(window, {
  ...
  dailySalesReportBtn: { get: () => dailySalesReportBtn, configurable: true },
